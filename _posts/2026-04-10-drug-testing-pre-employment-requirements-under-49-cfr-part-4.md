...
Carriers should also note that the [annual MVR review](https://blog.thetruckercodex.com/annual-mvr-review-what-carriers-must-check-and-document/) and [road test certification requirements](https://blog.thetruckercodex.com/road-test-requirements-when-a-certificate-of-violations-is-n/) carry their own enforcement risk profiles, and deficiencies in multiple DQ file elements compound during a compliance review, elevating the carrier's overall SMS BASIC scores.
