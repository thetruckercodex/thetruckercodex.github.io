...
description: "Brake defects are a leading vehicle OOS trigger. Learn what inspectors check, why OOS decisions happen, and the preventive controls that reduce exposure."
---
...
Official reference: https://www.ecfr.gov/current/title-49/subtitle-B/chapter-III/subchapter-B/part-393 :contentReference[oaicite:1]{index=1}
...
Reference: https://cvsa.org/inspections/out-of-service-criteria/ :contentReference[oaicite:2]{index=2}
...
Brake violations are frequently discovered alongside issues such as **[Tire Defects and OOS Criteria](/tire-defects-out-of-service-criteria/)** and missing inspection documentation.
...
Owner-operators operating under tight schedules may unintentionally deprioritize measurement checks, especially when no obvious performance issue is felt during driving.
...
Driver-side compliance issues such as log accuracy are handled separately in our **[Hours-of-Service Rules Guide](/hours-of-service-rules/)**.
