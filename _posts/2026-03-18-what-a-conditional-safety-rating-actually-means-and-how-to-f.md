---
layout: post
title: "What a Conditional Safety Rating Actually Means and How to Fix It"
date: 2026-03-18
categories: audits-violations
description: "Enforcement intelligence analysis: What a Conditional Safety Rating Actually Means and How to Fix It. Data-driven insights from FMCSA and CVSA records for motor carriers and compliance professionals."
---
...
Under [49 CFR Part 385](https://www.ecfr.gov/current/title-49/subtitle-B/chapter-III/subchapter-B/part-385), FMCSA assigns one of three safety ratings following a compliance review: Satisfactory, Conditional, or Unsatisfactory. A Conditional rating is issued when a carrier has demonstrated deficiencies in its safety management controls but has not crossed the threshold for an Unsatisfactory rating or an imminent hazard declaration.
...
Understanding [how FMCSA selects carriers for compliance reviews](https://blog.thetruckercodex.com/how-fmcsa-selects-carriers-for-compliance-reviews-the-data-b/) is the first intelligence layer here. Selection is largely driven by SMS (Safety Measurement System) BASIC percentile scores, crash history, and complaint data. Carriers with elevated scores in the HOS Compliance or Vehicle Maintenance BASICs are disproportionately targeted. If you have not audited [your CSA scorecard for risk concentration](https://blog.thetruckercodex.com/how-to-read-your-csa-scorecard-and-identify-your-biggest-ris/), you are operating without situational awareness.

### Common Violation Patterns That Produce Conditional Ratings

Based on FMCSA compliance review data and [FMCSA safety statistics](https://www.fmcsa.dot.gov/safety/data-and-statistics), the following violation categories appear most frequently in Conditional rating determinations:
...
Carriers that see roadside inspection violations accumulating should treat that data as a leading indicator. The roadside record is often the first dataset a compliance investigator reviews before the on-site audit begins. Knowing [what triggers a DOT compliance audit](https://blog.thetruckercodex.com/dot-compliance-audit-triggers/) — and addressing those triggers proactively — is the only reliable way to interrupt this pipeline before a rating is issued.
...
For carriers under the new entrant program, the rating framework operates under additional scrutiny. The [new entrant safety audit methodology](https://blog.thetruckercodex.com/new-entrant-safety-audit-fmcsa-methodology/) is specifically designed to assess whether a carrier has functional safety management systems before the 18-month provisional period concludes. A Conditional finding during that window compresses the remediation timeline significantly and carries elevated revocation risk.
...
Ensure every driver operating under your authority carries the [eight required cab documents](https://blog.thetruckercodex.com/the-8-documents-you-must-have-in-the-cab-during-any-inspecti/) at all times. Roadside inspection failures on documentation violations directly feed the same factors that generate and sustain a Conditional rating.
