---
layout: post
title: "Road Test Requirements: When a Certificate of Violations Is Not Enough"
date: 2026-04-06
categories: dqf
description: "Comprehensive analysis of Road Test Requirements: When a Certificate of Violations Is Not Enough under 49 CFR Part 391. Regulatory requirements, enforcement consequences, and compliance guidance for motor carriers."
---

Motor carriers routinely conflate driver licensing documentation with the full scope of pre-employment qualification requirements. A commercial driver's license and a completed certificate of violations satisfy distinct regulatory obligations — neither substitutes for the other. When it comes to demonstrated operational competence, 49 CFR §391.31 establishes an independent and non-negotiable requirement: the road test. Understanding where that requirement applies, when it may be waived, and what constitutes a compliant examination is essential to building a defensible [driver qualification file](https://blog.thetruckercodex.com/driver-qualification-file-requirements/).
...
Carriers should also understand that road test compliance does not replace the ongoing obligation to review an [annual MVR](https://blog.thetruckercodex.com/annual-mvr-review-what-carriers-must-check-and-document/) or to evaluate medical fitness under 49 CFR Part 391, Subpart E. Medical qualification issues — including those addressed by the [diabetes exemption program](https://blog.thetruckercodex.com/diabetes-exemption-program-how-cdl-drivers-with-itdm-qualify/) and federal [vision and hearing standards](https://blog.thetruckercodex.com/vision-and-hearing-standards-for-cdl-holders/) — remain entirely independent of the road test requirement and must be separately documented.
...
**Primary Source:** [49 CFR §391.31 — eCFR](https://www.ecfr.gov/current/title-49/part-391/section-391.31)  
**Agency Reference:** [Federal Motor Carrier Safety Administration](https://www.fmcsa.dot.gov/)
