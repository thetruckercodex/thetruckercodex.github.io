...
Understanding [how violation severity weights affect your CSA score](https://blog.thetruckercodex.com/violation-severity-weights-why-some-tickets-cost-you-more-cs/) is essential context here: a brake hose defect (BASIC violation code 393.45) scores differently in the Safety Measurement System than a fatigued driving OOS order. Both are avoidable with pre-Roadcheck preparation, but they require different remediation approaches.
...
Roadcheck inspections are entered into the FMCSA Motor Carrier Management Information System (MCMIS) and flow directly into CSA BASIC calculations. The [FMCSA safety data portal](https://www.fmcsa.dot.gov/safety/data-and-statistics) reflects inspection results within 30–60 days, meaning a bad Roadcheck week can move a carrier's percentile rank materially — sometimes enough to trigger intervention.
...
That path — from alert status to formal review — is covered in detail in [what a Conditional safety rating actually means and how carriers recover from it](https://blog.thetruckercodex.com/what-a-conditional-safety-rating-actually-means-and-how-to-f/). The time to understand that process is before Roadcheck, not after.
