---
layout: post
title: "Periodic Inspection Requirements: What the Annual DOT Inspection Must Cover"
date: 2026-05-02
categories: maintenance
description: "Comprehensive analysis of Periodic Inspection Requirements: What the Annual DOT Inspection Must Cover under 49 CFR Part 396. Regulatory requirements, enforcement consequences, and compliance guidance for motor carriers."
---
...
Brake deficiencies remain the single most frequent basis for both periodic inspection failures and roadside out-of-service orders. Carriers should cross-reference the detailed brake system standards analyzed at [brake system violations and out-of-service criteria](https://blog.thetruckercodex.com/brake-system-violations-out-of-service/) to ensure pre-inspection brake compliance, particularly regarding brake adjustment limits and lining thickness thresholds.
...
1. The vehicle inspected, by unit number or VIN
2. The date of inspection
3. The name of the person who performed the inspection
4. The motor carrier operating the vehicle
5. The signature of the inspector certifying that the vehicle passed the inspection criteria of Appendix G
...
The [FMCSA](https://www.fmcsa.dot.gov/) publishes current out-of-service criteria guidance and enforcement policy updates that carriers should monitor as part of an active compliance program. The full regulatory text of §396.17 is available directly at the [eCFR — 49 CFR §396.17](https://www.ecfr.gov/current/title-49/part-396/section-396.17).
