---
layout: post
title: 'Clearinghouse Phase II: CDL Downgrade Enforcement — What Carriers and Drivers Must Do Right Now'
...
Phase II — the second Clearinghouse final rule ([86 FR 55718](https://www.federalregister.gov/documents/2021/10/07/2021-21928/controlled-substances-and-alcohol-testing-state-drivers-licensing-agency-non-issuancedowngrade-of)) — eliminates that gap by making SDLA participation mandatory.

***

## What Changed on November 18, 2024

Under [49 CFR § 383.73](https://www.ecfr.gov/current/title-49/subtitle-B/chapter-III/subchapter-B/part-383/subpart-D/section-383.73), SDLAs are now required to:

- Query the [FMCSA Clearinghouse](https://clearinghouse.fmcsa.dot.gov/) before issuing, renewing, upgrading, or transferring any CDL or CLP
...
**Annual limited queries are not sufficient for new hires.** A limited query tells you whether a record exists; it does not give you the content. For any new hire, a full query with the driver's electronic consent is required before the driver operates a CMV. Refusing to provide consent is itself treated as a violation under [49 CFR Part 382](https://www.ecfr.gov/current/title-49/subtitle-B/chapter-III/subchapter-B/part-382).
...
For an overview of what belongs in that file, see [Driver Qualification File Requirements](/driver-qualification-file-requirements/).

> **DQF Tab** — The Trucker Codex binder system includes a dedicated Driver Qualification File section with the filing structure, checklists, and retention schedule auditors expect. [See what's included →](https://www.etsy.com/shop/TheTruckerCodex)
...
The standard query obligations are covered in our [FMCSA Clearinghouse Guide](/fmcsa-clearinghouse-guide/).

***

## The Return-to-Duty (RTD) Path

A CDL downgrade is not permanent. The path back is structured under [49 CFR Part 40, Subpart O](https://www.ecfr.gov/current/title-49/subtitle-A/part-40/subpart-O), and involves:

1. **SAP Evaluation** — A qualified Substance Abuse Professional assesses the driver and recommends treatment or education
2. **Program Compliance** — The driver completes the prescribed treatment or education program
3. **RTD Drug/Alcohol Test** — A supervised, negative test result is required before return
4. **Follow-Up Testing** — Unannounced tests over a minimum of 12 months, up to 60 months
...
FMCSA's [Return-to-Duty resources](https://clearinghouse.fmcsa.dot.gov/Learn/Topic/Return-to-Duty) include a Quick Reference Guide and step-by-step video.

> **Drug & Alcohol Tab** — TCX Vol.1 includes a Drug & Alcohol Program section with SAP referral tracking, RTD documentation, and follow-up testing logs — organized the same way your binder's other five sections are. [View the system →](https://www.etsy.com/shop/TheTruckerCodex)
...
Failure to maintain these records is a direct [DOT compliance audit trigger](/dot-compliance-audit-triggers/) — and the audit exposure compounds if a violation is discovered that the carrier could have detected through required queries.

For a complete record retention framework, see [DOT Recordkeeping and Document Retention](/dot-recordkeeping-document-retention/).
...
1. Run a full Clearinghouse query on every currently employed CDL driver if you have not done so in the past 12 months
2. Verify that your annual limited query calendar is current for all drivers
3. Confirm that your pre-employment process requires a full query before any new CDL driver operates a CMV
4. Document all query results and store them in the Driver Qualification File
5. If a driver returns a "prohibited" status, remove them from safety-sensitive functions immediately — same day, not within the grace period
6. Do not rely on the physical CDL card as proof of valid commercial driving authority — verify CDLIS status

For a consolidated 2026 compliance checklist, see [DOT Compliance Checklist 2026](/dot-compliance-checklist-2026/).

If you want all six compliance areas — DQF, Drug & Alcohol, HOS, Vehicle Maintenance, Insurance, and Company Files — organized into one indexed binder that's built for owner-operators and small fleets, [TCX Vol.1 is on Etsy](https://www.etsy.com/shop/TheTruckerCodex). Set it up once, maintain it weekly.

***

## Related Compliance Topics

- [FMCSA Clearinghouse Guide](/fmcsa-clearinghouse-guide/)
- [Driver Qualification File Requirements](/driver-qualification-file-requirements/)
- [DOT Pre-Employment Requirements](/dot-pre-employment-requirements/)
