---
layout: post
title: "The 60/70-Hour Rule: How to Calculate Your Available Hours"
date: 2026-03-13
categories: hos-eld
description: "Comprehensive analysis of The 60/70-Hour Rule: How to Calculate Your Available Hours under 49 CFR Part 395. Regulatory requirements, enforcement consequences, and compliance guidance for motor carriers."
---
...
For a complete orientation to the full hours of service architecture before diving into the cumulative limit specifically, see the [overview of hours of service rules](https://blog.thetruckercodex.com/hours-of-service-rules/) at The Trucker Codex.
...
The threshold question — which limit applies — turns on the carrier's operational pattern, not the individual driver's schedule. [FMCSA's regulatory guidance](https://www.fmcsa.dot.gov/) has consistently held that a carrier "operates every day of the week" if it regularly dispatches CMVs on all seven days, even if a specific driver does not work all seven. This determination is made at the carrier level and should be documented in the motor carrier's safety management controls. Carriers that operate only Monday through Friday, for example, are subject to the 60-hour/7-day limit, while carriers with seven-day operations — common in truckload, tanker, and logistics sectors — fall under the 70-hour/8-day framework.
...
Carriers should note that the 2013 rule amendments imposing restrictions on when the 34-hour restart could be used — specifically the two 1:00–5:00 a.m. off-duty period requirements — were suspended by Congress in 2014 and have not been reinstated. The restart as currently enforceable under [49 CFR §395.3(b)](https://www.ecfr.gov/current/title-49/part-395/section-395.3(b)) requires only 34 consecutive hours of off-duty or sleeper berth time with no qualifying time-of-day conditions.
...
Familiarity with the [consequences of hours of service violations and out-of-service orders](https://blog.thetruckercodex.com/hours-of-service-violations-out-of-service/) is essential for any driver operating near the cumulative threshold.
