...
[FMCSA Large Truck Crash Facts data](https://www.fmcsa.dot.gov/safety/data-and-statistics/large-truck-and-bus-crash-facts) consistently identifies driver fatigue as a contributing factor in a meaningful percentage of fatal large-truck crashes. That data is publicly available, routinely cited in expert witness testimony, and used to establish industry-wide risk patterns in front of juries.
