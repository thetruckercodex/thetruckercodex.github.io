---
layout: post
title: "CDL Medical Certificate Requirements: Timing, Forms, and Filing"
date: 2026-03-24
categories: dqf
description: "Comprehensive analysis of CDL Medical Certificate Requirements: Timing, Forms, and Filing under 49 CFR Part 391. Regulatory requirements, enforcement consequences, and compliance guidance for motor carriers."
---
...
Carriers who also have not completed required [Clearinghouse pre-employment queries](https://blog.thetruckercodex.com/the-clearinghouse-query-carriers-most-often-forget-to-run/) compound their regulatory exposure during an audit, since FMCSA investigators reviewing a DQF examine the full qualification record — medical certification, Clearinghouse query, road test, and employment history — as an integrated compliance package. Similarly, any situation involving a [drug test refusal](https://blog.thetruckercodex.com/drug-test-refusal-what-it-means-for-a-cdl-and-how-carriers-m/) will interact with the medical certification record during the return-to-duty process, requiring the SAP evaluation and follow-up testing to be fully documented before the driver can be recertified for CMV operation.
...
**Build an audit-ready Driver Qualification File system:** [Driver Qualification File Bundle — The Trucker Codex](https://www.etsy.com/shop/TheTruckerCodex)
...
| Authority | Citation |
|---|---|
| Medical Examination and Certificate | [49 CFR §391.43](https://www.ecfr.gov/current/title-49/part-391/section-391.43) |
...
| FMCSA National Registry | [fmcsa.dot.gov](https://www.fmcsa.dot.gov/) |
